    ...
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Box sx={{ mb: 10, textAlign: "center" }}>
        ...
        >
          ...
          accessoires technologiques. Depuis notre création, nous nous engageons
          à offrir des produits de qualité à des prix compétitifs.
        </Typography>
      </Box>
          ...
          >
            <CardContent sx={{ p: 4 }}>
              ...
              <Typography color="text.secondary" sx={{ lineHeight: 1.8 }}>
                ...
                technologiques de haute qualité, en garantissant une expérience
                d'achat fluide, des prix justes et un service client
                irréprochable.
              </Typography>
            </CardContent>
          </Card>
